...
class TestUsers:
    ...
    def test_get_user_quantity(self, get_reqres):

        step = Step(get_reqres)

        step.get_user_quantity()

        step.assert_quantity_users()

    def test_create_user(self, get_reqres):
    ...
    def test_check_user_list_schema(self, get_reqres):
    ...
    def test_total_page_in_user_list(self, get_reqres):
        step = Step(get_reqres)
    ...
    def test_compare_users_and_single_user_data(self, get_reqres):
        step = Step(get_reqres)
    ...
    def test_status_code_user_list(self, get_reqres):
        step = Step(get_reqres)
    ...
    def test_date_create_user(self, get_reqres):
        step = Step(get_reqres)
    ...
    def test_check_token(self, get_reqres):
        step = Step(get_reqres)
    ...
    def test_unsuccessful_register(self, get_reqres):
        step = Step(get_reqres)
    ...
    def test_400_responce_unsuccessful_register(self, get_reqres):
        step = Step(get_reqres)
